...
function dash(m){
  ...
  m.innerHTML='<div class="grid2">'+[[c.New,'d_new'],[c.Contacted+c['In Progress'],'d_prog'],[c.Resolved,'d_done'],[pend,'d_rev']].map(x=>'<div class="tile"><span class="big">'+x[0]+'</span><span class="mut">'+esc(t(x[1]))+'</span></div>').join('')+'</div>'+
