...
const CACHE_NAME = "lhi-user-v4";
const APP_SHELL = ["./", "./index.html", "./manifest.json", "./app.js", "./shared/ui.css", "./shared/config.js", "./shared/content.js", "./logo.svg", "./icons/icon-192.png", "./icons/icon-512.png"];
